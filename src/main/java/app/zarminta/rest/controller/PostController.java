...
public class PostController {
    ...
    @GetMapping("/tags")
    public ResponseEntity<Object> getAllByTags(PostByTagRequest tagRequest){
        return postService.getAllPostByTags(tagRequest);
    }

    @GetMapping("/categories")
    public ResponseEntity<Object> getAllByCategories(PostByTagCategory postByTagCategory){
        return postService.getAllPostByCategories(postByTagCategory);
    }
